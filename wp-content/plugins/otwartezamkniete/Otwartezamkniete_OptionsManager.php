...
class Otwartezamkniete_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'otwartezamkniete'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'otwartezamkniete'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'otwartezamkniete'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'otwartezamkniete'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'otwartezamkniete');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'otwartezamkniete'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'otwartezamkniete');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'otwartezamkniete'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'otwartezamkniete') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'otwartezamkniete');
            case 'false':
                return __('false', 'otwartezamkniete');

            case 'Administrator':
                return __('Administrator', 'otwartezamkniete');
            case 'Editor':
                return __('Editor', 'otwartezamkniete');
            case 'Author':
                return __('Author', 'otwartezamkniete');
            case 'Contributor':
                return __('Contributor', 'otwartezamkniete');
            case 'Subscriber':
                return __('Subscriber', 'otwartezamkniete');
            case 'Anyone':
                return __('Anyone', 'otwartezamkniete');
        }
        return $optionValue;
    }
