	...
	VariationForm.prototype.onFindVariation = function( event ) {
		...
		if ( attributes.count === attributes.chosenCount ) {
			if ( form.useAjax ) {
				...
				currentAttributes.action = 'gaad_get_variation';
				...
				form.xhr                      = $.ajax( {
					...
					success: function( variation ) {
						if ( variation ) {
							...
							naklady_app.q = variation.q;
							
							productSummaryApp.variation_id = variation.variation_id;
				...
				if ( variation ) {
					...
					/*
					* Niektóre produkty tworza warianty dopiero po wybraniu odpowiedniej kombinacji przez kupującego
					* Wyłączenie komunikatu o braku wariantu dla wybranych rodzajów produktów używających konkretnych kalkulatorów
					* Sprawdzanie dostępności wariantu wyłączone dla produktów używających kalkulatora:
					* - ksiazki
					* - katalog
					* - outdoor_baner
					* 
					*/
					if( 
						! jQuery('body').is('.gaad-calc-ksiazka') && 
						! jQuery('body').is('.gaad-calc-katalog') && 
						
						! jQuery('body').is('.gaad-calc-outdoor_baner') && 
						! jQuery('body').is('.gaad-calc-outdoor_plakat') && 
						! jQuery('body').is('.gaad-calc-outdoor_owv') && 
						! jQuery('body').is('.gaad-calc-outdoor_monomer') && 
						! jQuery('body').is('.gaad-calc-outdoor_xbaner') 
