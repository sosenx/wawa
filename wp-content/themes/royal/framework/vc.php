	   ...
	   $setting_vc_gallery = array(
	    ...
	    $follow_params = array(
          ...
          'params' => array(
            ...
            array(
              "type" => "textfield",
              "heading" => __("Extra class name", ETHEME_DOMAIN),
              "param_name" => "class"
            ),
	    ...
	    $et_top_cart = array(
          ...
          'params' => array(
     		array(
	          ...
	          "heading" => __("Style", ETHEME_DOMAIN),
	          "param_name" => "color",
	          "value" => array( __( 'Dark', ETHEME_DOMAIN ) => 'dark', __( 'light', ETHEME_DOMAIN ) => 'light' ),
	        ),
            array(
	          "type" => "dropdown",
	          "heading" => __("Enable dropdown", ETHEME_DOMAIN),
	          "param_name" => "dropdown",
	          "value" => array( __( 'on', ETHEME_DOMAIN ) => 'on', __( 'off', ETHEME_DOMAIN ) => 'off'),
	        ),
	        array(
              "type" => "dropdown",
              "heading" => __("Position", ET_DOMAIN),
              "param_name" => "position",
              "value" => array( __( "Right", ET_DOMAIN ) => "right", __( "Left", ET_DOMAIN ) => "left", __( "Center", ET_DOMAIN) => "center" ),
            ),
	        array(
              "type" => "textfield",
              "heading" => __("Extra class name", ETHEME_DOMAIN),
	    ...
	    $et_menu = array(
          ...
          'params' => array(
          	 array(
				...
				"heading" => __("Position", ET_DOMAIN),
				"param_name" => "position",
				"value" => array( __("Left", ET_DOMAIN) => "left", __("Right", ET_DOMAIN) => "right", __("Center", ET_DOMAIN) => "center"),
            ),
            array(
				"type" => 'checkbox',
				"heading" => __("Mobile Trigger", ETHEME_DOMAIN ),
				"param_name" => "mobile",
				"value" => Array(__("Yes, please", ETHEME_DOMAIN ) => 'on')
		    ),
            array(
				"type" => "textfield",
				"heading" => __( "Extra class name", ETHEME_DOMAIN ),
	    ...
	    $et_top_search = array(
          ...
          'params' => array(
            array(
	          "type" => "dropdown",
	          "heading" => __("View", ETHEME_DOMAIN),
	          "param_name" => "view",
	          "value" => array( __( 'Popup', ETHEME_DOMAIN ) => 'modal', __( 'Hover', ETHEME_DOMAIN ) => 'hover', __( 'Default', ETHEME_DOMAIN ) => 'default'),
	        ),
	        array(
              "type" => "textfield",
              "heading" => __("Extra class name", ETHEME_DOMAIN),
	    ...
	    $et_links = array(
          ...
          'params' => array(
          	array(
              "type" => "colorpicker",
              "heading" => __("Links text color", ETHEME_DOMAIN),
              "param_name" => "color",
            ),
            array(
              "type" => "colorpicker",
              "heading" => __("Links hover text color", ETHEME_DOMAIN),
	        ...
	        array(
              "type" => "checkbox",
              "heading" => __("Enable Register Link", ETHEME_DOMAIN),
              "param_name" => "register",
            ),
            array(
              "type" => "checkbox",
              "heading" => __("Enable Newsletter Link", ETHEME_DOMAIN),
