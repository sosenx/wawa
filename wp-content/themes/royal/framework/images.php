...
if ( !function_exists('vt_resize') ) {
	function vt_resize( $attach_id = null, $img_url = null, $width, $height, $crop = false) {
		...
		// this is not an attachment, let's use the image url
			...
			if ( isset( $_SERVER['SUBDOMAIN_DOCUMENT_ROOT'] ) && ! empty( $_SERVER['SUBDOMAIN_DOCUMENT_ROOT'] ) && empty( $file_path ) ) {

		    	$file_path = $_SERVER['SUBDOMAIN_DOCUMENT_ROOT'] . $file_path['path'];
		    }
