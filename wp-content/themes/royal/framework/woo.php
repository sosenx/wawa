...
global $woocommerce;
		...
		<div class="shopping-cart-widget" id='basket'>
			<a href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" class="cart-summ" data-items-count="<?php echo WC()->cart->cart_contents_count; ?>">
			<div class="cart-bag">
				...
				<span class='shop-text'><?php _e('Cart', ETHEME_DOMAIN) ?>: <span class="total"><?php echo WC()->cart->get_cart_subtotal(); ?></span></span> 
        ...
        $ajax = etheme_get_option( 'ajax_addtocart' ) ? ' ajax-remove' : '';
          ...
          <?php
            ...
            foreach ( $woocommerce->cart->get_cart() as $cart_item_key => $cart_item ) {
                ...
                ?>
					<li>
						<?php 
                            echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf('<a href="%s" data-key="%s" class="close-order-li' . $ajax . '" title="%s"></a>', esc_url( $woocommerce->cart->get_remove_url( $cart_item_key ) ), $cart_item_key, __('Remove this item', ETHEME_DOMAIN) ), $cart_item_key ); 
                        ?>
						<div class="media">
