...
if(!function_exists('et_enqueue_gfonts')) {
    function et_enqueue_gfonts() {
        /*
		wp_enqueue_style("font-open-sans",et_http()."fonts.googleapis.com/css?family=Open+Sans:300,400,700,300italic&subset=latin,latin-ex");
        wp_enqueue_style("font-roboto",et_http()."fonts.googleapis.com/css?family=Roboto:100,400,500,700,300&subset=latin,latin-ext");
		*/
		wp_enqueue_style("font-open-sans-roboto","https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,700|Roboto:100,300,400,500,700&amp;subset=latin-ext");        
